...
if __name__ == '__main__':
    ...
    plt.savefig(pjoin(cwd, 'data', 'figs', f'mimic_density_self_kd_metrics.pdf'))
    plt.close()
    ...
    plt.savefig(pjoin(cwd, 'data', 'figs', f'mimic_density_self_kd_metrics-gray.pdf'))
