...
from models import MCDroptoutSAGE as SAGE
from utils.gnn import train, test, mc_inference
...
def main(args):
    ...
    try:
        os.makedirs(pjoin(cwd, 'saved_info_graph_classification', 'mc_dropout_enzymes'))
    ...
    for train_index, test_index in skf.split(iid_data, labels):
        ...
        with open(pjoin(cwd, 'saved_info_graph_classification', 'mc_dropout_enzymes',
        ...
        with open(
                pjoin(cwd, 'saved_info_graph_classification', 'mc_dropout_enzymes',
